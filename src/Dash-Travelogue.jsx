...
const sections = ["CONTEXT:", "PLANNING:", "", "THE TASK:", "STATE:", "GOALS:"]
const descriptions = [
...
class DashTravelogue extends Component {
	constructor(props) {
		super(props)
	...
	getDisplay() {
		if (this.props.parent.state.page.toLowerCase() === "event travelogue") {
			return {display: "flex"}
		}
		return {display: "none"}
	}
