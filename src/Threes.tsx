...
import FirstTry from './images/threes/first-try.PNG'
import DayOne from './images/threes/day_1.PNG'
import Gameplay from './images/threes.PNG'
import ProjectPage from './Project';

export default class Threes extends ProjectPage {
	sections = ["INTRO:", "SOCKET.IO:", "ATTEMPT 1:", "ATTEMPT 2:", "OPTIMIZATION:", "SOLUTION:", "CONCLUSION:"]
	descriptions = [
		"During my third semester of college, my friends and I became obsessed with this simple card game, where all of the players would play until there was only one person left in the game. I was bored over that winter break, and ended up dedicating a couple of weeks creating a web-based version of the game (with the intention that I could play it with my friends while away from school).",
