...
export default class Iterative extends ProjectPage {

	sections = ["DISCLAIMER:", "INTRO:", "", "ESSENTIALS:", "SKETCHES", "PROTOTYPING:", "CRITIQUE:", "EYETRACKING:", "THE TASK:", "RESULTS:", "CONCLUSION:", "NEXT STEPS:"]
	descriptions = [
			...
			<div id="project-cont">
				...
				<div id="info-cont">
					...
					<ContentBlock section="" content={
						<iframe style={{ border: 'none', width: '70vw', height: '30vw' }} src="https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com%2Ffile%2Ff4bIRsOei5Z3gbAo67J8wK2D%2FIterative%3Fnode-id%3D2%253A0" allowFullScreen={true}></iframe>} />
					{this.renderInfo(6, 9)}
